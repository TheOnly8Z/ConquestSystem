ConquestSystem.Config = {
	...
	Visibility = {
		...
		Fade = {
			...
			FadeInStartDistance = 30, 			-- how far (in m) the player should be before the icon STARTS to fade in.
			
			FadeInEndDistance = 10			-- how far (in m) the player is for the icon to be TOTALLY visible.
		}

	},

	Rewards = { 							-- reward system, requires darkrp.

		Enabled = true,

		OnCapture = {

			ForPlayer = 500, 				-- for the player who captures the point.

			ForTeam = 100, 					-- for each player in the team.

			ForCategory = 100   -- for each player in the category.

		},

		WhileCaptured = {

			Interval = 5,					-- how many seconds between giving rewards.
